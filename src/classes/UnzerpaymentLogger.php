...
use UnzerPayment\Classes\Helper\UnzerpaymentAdminConfigFormHelper;
...
class UnzerpaymentLogger
{
    ...
    public function addLog(
        ...
        if ($this->loglevel >= $loglevel) {
            ...
            if ($loglevel == 1) {
                \PrestaShopLogger::addLog($message, 3, null, 'UnzerPayment');
            }
            if ($exception) {
    ...
    {
        return $this->getLogDir() . 'unzerpayment.log';
    }
    ...
    {
        $vars = UnzerpaymentAdminConfigFormHelper::getConfigFormValues(new \Unzerpayment());
        return $vars;
    }
    ...
    public function getLogContent()
    {
        $debuginfo = array(
            ...
            'Plugin Version' => \Unzerpayment::getVersion(),
